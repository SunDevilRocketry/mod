...
typedef enum
	{
		...
		SENSOR_MAGHALL_CONV = 0x09,
		SENSOR_ROLL_DEG 	= 0x0A,
		SENSOR_PITCH_DEG 	= 0x0B,
		SENSOR_YAW_DEG		= 0x0C,
		SENSOR_ROLL_RATE 	= 0x0D,
		SENSOR_PITCH_RATE 	= 0x0E,
		SENSOR_YAW_RATE		= 0x0F,
		SENSOR_VELOCITY 	= 0x10,
		SENSOR_VELO_X		= 0x11,
		SENSOR_VELO_Y		= 0x12,
		SENSOR_VELO_Z		= 0x13,
		SENSOR_POSITION 	= 0x14,
		SENSOR_PRES  		= 0x15,
		SENSOR_TEMP  		= 0x16,
		SENSOR_BARO_ALT		= 0x17,
		SENSOR_BARO_VELO	= 0x18,
		SENSOR_GPS_ALT		= 0x19,
		SENSOR_GPS_SPEED	= 0x1A,
		SENSOR_GPS_TIME		= 0x1B,
		SENSOR_GPS_DEC_LONG	= 0x1C,
		SENSOR_GPS_DEC_LAT 	= 0x1D,
		SENSOR_GPS_NS		= 0x1E,
		SENSOR_GPS_EW		= 0x1F,
		SENSOR_GPS_GLL		= 0x20,
		SENSOR_GPS_RMC		= 0x21,
