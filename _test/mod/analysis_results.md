...
| --- | --- | --- | --- |
| `RQ.MOD.00001` | The library shall be designed to interface with the Sun Devil Rocketry "driver" library. | Many of the modules in this library are dependent on interfaces provided by driver. Those that are not are completely platform independent. | <span style="color: #15803d"><strong>PASS</strong></span> |
