...
typedef enum IGN_STATUS
	...
	IGN_PRE_FIRE_START 	 = 0X4B,
	IGN_FILL_CHILL_START = 0X4C,
	IGN_HOT_FIRE_START   = 0X4D,
	IGN_STAND_BY_START   = 0X4E, 
	IGN_PRE_FIRE_DONE  	 = 0X50,
	IGN_FILL_CHILL_DONE  = 0X51,
	IGN_HOT_FIRE_DONE    = 0X52,
	IGN_STAND_BY_DONE    = 0X53,
	IGN_PRE_FIRE_FAIL 	 = 0X54,
	IGN_FILL_CHILL_FAIL  = 0X55,
	IGN_HOT_FIRE_FAIL    = 0X56,
	IGN_STAND_BY_FAIL    = 0X57 
	} IGN_STATUS;
